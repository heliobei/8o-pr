...
const TwoColumnLayoutTeacher = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 to-green-300 z-0">
      ...
      >
        ...
        <div className='pt-16'>
            ...
            <p className='text-white text-center text-lg p-4 pb-8'>Acesse os livros didáticos do oitavo ano para o educador e alunos.</p>
            <BooksCard />
