    ...
    <div className="max-w-5xl mx-auto my-10 p-6 bg-white shadow-lg rounded-2xl grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
      ...
      <div>
        ...
        <p className="text-gray-700 leading-relaxed">
          <Link
            href="https://classroom.google.com/c/NzAwNjUyNDg0Mzk1?cjc=7zy4gjp"
            target="_blank"
          ...
          para acessar a turma modelo do oitavo ano no Google Sala de Aula, usando sua conta Google Educacional. 
